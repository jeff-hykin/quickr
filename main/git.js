...
var ASM_CONSTS = {
    ...
    111850: ($0, $1) => {
        const url = UTF8ToString($0)
        return Module.emscriptenhttpconnect(url, $1, "POST", { "Content-Type": url.indexOf("git-upload-pack") > 0 ? "application/x-git-upload-pack-request" : "application/x-git-receive-pack-request" })
    },
    112079: ($0, $1, $2) => {
...
var ___errno_location = function () {
    return (___errno_location = Module["asm"]["$"]).apply(null, arguments)
}
var _main = (Module["_main"] = function () {
    return (_main = Module["_main"] = Module["asm"]["aa"]).apply(null, arguments)
})
var _htonl = function () {
    return (_htonl = Module["asm"]["ba"]).apply(null, arguments)
}
var _ntohs = function () {
    return (_ntohs = Module["asm"]["ca"]).apply(null, arguments)
}
var _htons = function () {
    return (_htons = Module["asm"]["da"]).apply(null, arguments)
}
var _emscripten_builtin_memalign = function () {
    return (_emscripten_builtin_memalign = Module["asm"]["ea"]).apply(null, arguments)
}
var stackAlloc = function () {
    return (stackAlloc = Module["asm"]["fa"]).apply(null, arguments)
}
